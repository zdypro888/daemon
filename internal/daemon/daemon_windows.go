...
// Install the service
func (windows *windowsRecord) Install(args ...string) error {
...
// Remove the service
func (windows *windowsRecord) Remove() error {
...
// Start the service
func (windows *windowsRecord) Start() error {
...
// Stop the service
func (windows *windowsRecord) Stop() error {
