...
// Install the service
func (bsd *bsdRecord) Install(args ...string) error {
...
// Remove the service
func (bsd *bsdRecord) Remove() error {
...
// Start the service
func (bsd *bsdRecord) Start() error {
...
// Run - Run service
func (bsd *bsdRecord) Run(e Executable) error {
	e.Run()
	return nil
}
